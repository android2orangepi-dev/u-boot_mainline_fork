...
#ULCB_MODEL-r8a7795 = h3
#ULCB_MODEL-r8a7796 = m3
#ULCB_MODEL = $(ULCB_MODEL-$(TARGET_BOARD_PLATFORM))

#UBOOT_DEFCONFIG_ulcb = $(ULCB_MODEL)ulcb_defconfig
#UBOOT_DEFCONFIG_kingfisher = $(ULCB_MODEL)ulcb_defconfig

#ifneq ($(UBOOT_DEFCONFIG_$(TARGET_BOOTLOADER_BOARD_NAME)),)
#	UBOOT_DEFCONFIG = $(UBOOT_DEFCONFIG_$(TARGET_BOOTLOADER_BOARD_NAME))
#else
#	UBOOT_DEFCONFIG = $(TARGET_BOARD_PLATFORM)_$(TARGET_BOOTLOADER_BOARD_NAME)_defconfig
#endif
